...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setCountByExampleStatementId("countByCondition"); //$NON-NLS-1$
        setDeleteByExampleStatementId("deleteByCondition"); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId("deleteByKey"); //$NON-NLS-1$
        setInsertStatementId("insert"); //$NON-NLS-1$
        setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByCondition"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByConditionWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("selectByKey"); //$NON-NLS-1$
        setUpdateByExampleStatementId("updateByCondition"); //$NON-NLS-1$
        setUpdateByExampleSelectiveStatementId("updateByConditionSelective"); //$NON-NLS-1$
        setUpdateByExampleWithBLOBsStatementId("updateByConditionWithBLOBs"); //$NON-NLS-1$
        setUpdateByPrimaryKeyStatementId("updateByKey"); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId("updateByKeySelective"); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateByKeyWithBLOBs"); //$NON-NLS-1$
        setBaseResultMapId("BaseResultMap"); //$NON-NLS-1$
        setResultMapWithBLOBsId("ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId("Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId("Column_List"); //$NON-NLS-1$
    ...
    protected void calculateModelAttributes() {
        ...
        sb.append(fullyQualifiedTable.getDomainObjectName());
        /**
         * 这块还没怎么看懂，复杂查询封装单独一个对象处理
         */
        //sb.append("Extend"); //$NON-NLS-1$
        // by walker
